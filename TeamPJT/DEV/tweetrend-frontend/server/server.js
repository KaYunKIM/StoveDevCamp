...
const QUERY_PARAMS =
  'expansions=attachments.media_keys,author_id,entities.mentions.username,in_reply_to_user_id,referenced_tweets.id,referenced_tweets.id.author_id&media.fields=media_key,preview_image_url,type,url&tweet.fields=id,text,attachments,author_id,conversation_id,created_at,entities,in_reply_to_user_id,public_metrics,possibly_sensitive,referenced_tweets,source,reply_settings&user.fields=id,name,username,profile_image_url,verified';
