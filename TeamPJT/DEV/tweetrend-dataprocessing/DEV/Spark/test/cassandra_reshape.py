...
# tweet['data']['text'], 
# int(tweet['data']['id']), 
# int(tweet['data']['author_id']), 
# tweet['data']['created_at'],
# tweet['data']['attachments'],
# int(tweet['data']['conversation_id']),
# tweet['data']['entities'],
# int(tweet['data']['in_reply_to_user_id']),
# tweet['data']['possibly_sensitive'],
# tweet['data']['public_metrics'],
# [{"type": tweet['data']['referenced_tweets']['type'],"id": int(tweet['data']['referenced_tweets']['id'])]
# tweet['data']['reply_settings'],
# tweet['data']['source'],
# tweet['data']['lang'],
# tweet['data']['geo'],